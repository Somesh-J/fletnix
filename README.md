...
- **Frontend**: [https://fletnix.vercel.app](https://fletnix.vercel.app)
- **Backend API**: [https://fletnix-api.onrender.com](https://fletnix-api.onrender.com)
...
- **Somesh J** - [GitHub](https://github.com/Somesh-J)

---

Made with ❤️ for solving Kartik's Netflix confusion!
